...
public class GroupChannelApi {
    ...
    public void getChannelList(OnCallback<ChannelPage> listener) {
        ...
        GitpleLiveChat.getInstance().groupChannelSdk.findAll((response, error) -> {
    ...
    public void getChannelList( int limit,
        ...
        GitpleLiveChat.getInstance().groupChannelSdk.findAll(   next,
                                                            limit,
                                                            showMembers,
                                                            showManagers,
                                                            showReadReceipt,
    ...
    public void getChannel(String channelId, OnCallback<GroupChannel> listener) {
        ...
        GitpleLiveChat.getInstance().groupChannelSdk.findOne(channelId, (response, error) -> {
            if (listener == null) return;
    ...
    public void createChannel(  String channelId,
        ...
        GitpleLiveChat.getInstance().groupChannelSdk.create( channelId, name, profile, members, reuse, meta, (response, error) -> {
            if (listener == null) return;
    ...
    public void updateChannel(String channelId,
        ...
        GitpleLiveChat.getInstance().groupChannelSdk.update(channelId, name, profile, (response, error) -> {
            if (listener == null) return;
    ...
    public void deleteChannel(String channelId, OnCallback<Boolean> listener) {
        ...
        GitpleLiveChat.getInstance().groupChannelSdk.delete(channelId, (response, error) -> {
            if (listener == null) return;
    ...
    public void getMemberList(String channelId, OnCallback<BaseUser[]> listener) {
        ...
        GitpleLiveChat.getInstance().groupChannelSdk.findMembers(channelId, (response, error) -> {
            if (listener == null) return;
    ...
    public void joinChannel(String channelId, OnCallback<Boolean> listener) {
        ...
        GitpleLiveChat.getInstance().groupChannelSdk.join(channelId, (response, error) -> {
            if (listener == null) return;
    ...
    public void leaveChannel(String channelId, OnCallback<Boolean> listener) {
        ...
        GitpleLiveChat.getInstance().groupChannelSdk.leave(channelId, (response, error) -> {
            if (listener == null) return;
    ...
    public void getManagerList(String channelId, OnCallback<BaseUser[]> listener) {
        ...
        GitpleLiveChat.getInstance().groupChannelSdk.findManagers(channelId, (response, error) -> {
            if (listener == null) return;
    ...
    public void registerManager(String channelId, String userId, OnCallback<Boolean> listener) {
        ...
        GitpleLiveChat.getInstance().groupChannelSdk.registerManager(channelId, userId, (response, error) -> {
            if (listener == null) return;
    ...
    public void deleteManager(String channelId, String userId, OnCallback<Boolean> listener) {
        ...
        GitpleLiveChat.getInstance().groupChannelSdk.unregisterManager(channelId, userId, (response, error) -> {
            if (listener == null) return;
    ...
    public void readMessage(String channelId, OnCallback<Boolean> listener) {
        ...
        GitpleLiveChat.getInstance().groupChannelSdk.read(channelId, (response, error) -> {
            if (listener == null) return;
    ...
    public void readMessage(String[] channelIds, OnCallback<Boolean> listener) {
        ...
        GitpleLiveChat.getInstance().usersSdk.read(channelIds, (response, error) -> {
            if (listener == null) return;
    ...
    public void deliveredMessage(String channelId, OnCallback<Boolean> listener) {
        ...
        GitpleLiveChat.getInstance().groupChannelSdk.delivered(channelId, (response, error) -> {
            if (listener == null) return;
    ...
    public void updateMeta(String channelId, Map<String, String> meta, OnCallback<GroupChannel> listener) {
        ...
        GitpleLiveChat.getInstance().groupChannelSdk.updateMeta(channelId, meta, (response, error) -> {
            if (listener == null) return;
    ...
    public void deleteMeta(String channelId, String[] keys, OnCallback<GroupChannel> listener) {
        ...
        GitpleLiveChat.getInstance().groupChannelSdk.deleteMeta(channelId, keys, (response, error) -> {
            if (listener == null) return;
    ...
    public void getOnlineMemberList(String channelId, OnCallback<String[]> listener) {
        ...
        GitpleLiveChat.getInstance().groupChannelSdk.findOnlineMembers(channelId, (response, error) -> {
            if (listener == null) return;
    ...
    public void freezeChannel(String channelId, boolean freeze, OnCallback<GroupChannel> listener) {
        ...
        GitpleLiveChat.getInstance().groupChannelSdk.freeze(channelId, freeze, (response, error) -> {
            if (listener == null) return;
    ...
    public void ban(String channelId, String userId, int seconds, String reason, OnCallback<BanInfo> listener) {
        ...
        GitpleLiveChat.getInstance().groupChannelSdk.ban(channelId, userId, seconds, reason, (response, error) -> {
            if (listener == null) return;
    ...
    public void unban(String channelId, String userId, OnCallback<Boolean> listener) {
        ...
        GitpleLiveChat.getInstance().groupChannelSdk.unban(channelId, userId, (response, error) -> {
            if (listener == null) return;
    ...
    public void getBannedList(String channelId, OnCallback<BanInfo[]> listener) {
        ...
        GitpleLiveChat.getInstance().groupChannelSdk.findBanList(channelId, (response, error) -> {
            if (listener == null) return;
    ...
    public void getMessageList(String channelId, OnCallback<BaseMessage[]> listener) {
        ...
        GitpleLiveChat.getInstance().groupChannelMessageSdk.get(channelId, 0, null, null, 0, null, (response, error) -> {
            if (listener == null) return;
    ...
    public void getMessageList(String channelId,
        ...
        GitpleLiveChat.getInstance().groupChannelMessageSdk.get(channelId, messageId, mode, type, limit, content, (response, error) -> {
            if (listener == null) return;
    ...
    public void sendMessage(String channelId, String text, Map<String, String> meta, OnCallback<BaseMessage> listener) {
        ...
        GitpleLiveChat.getInstance().groupChannelMessageSdk.create(channelId, "text", text, meta, (response, error) -> {
            if (listener == null) return;
    ...
    public void sendMessage(String channelId, File file, Map<String, String> meta, OnCallback<BaseMessage> listener) {
        ...
        String url = GitpleLiveChat.getInstance().groupChannelMessageSdk.getUrl() + channelId + "/messages";
        Map<String, String> headers = GitpleLiveChat.getInstance().groupChannelMessageSdk.getHeaders();
    ...
    public void deleteMessage(String channelId, long messageId, OnCallback<Boolean> listener) {
        ...
        GitpleLiveChat.getInstance().groupChannelMessageSdk.delete(channelId, messageId, (response, error) -> {
            if (listener == null) return;
    ...
    public void updateMessageMeta(String channelId, long messageId, Map<String, String> meta, OnCallback<BaseMessage> listener) {
        ...
        GitpleLiveChat.getInstance().groupChannelMessageSdk.updateMeta(channelId, messageId, meta, (response, error) -> {
            if (listener == null) return;
    ...
    public void deleteMessageMeta(String channelId, long messageId, String[] keys, OnCallback<BaseMessage> listener) {
        ...
        GitpleLiveChat.getInstance().groupChannelMessageSdk.deleteMeta(channelId, messageId, keys, (response, error) -> {
            if (listener == null) return;
